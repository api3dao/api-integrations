...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8921],
  {
    90717: function (n) {
            ...
            if ('graphql' === n.language)
              for (
                ...
                if ('keyword' === a.type && 'mutation' === a.content) {
                  var i = [];
                  if (isTokenType(['definition-mutation', 'punctuation']) && '(' === t[e + 1].content) {
                    e += 2;
                    var r = findClosingBracket(/^\($/, /^\)$/);
                    if (-1 === r) continue;
                    for (; e < r; e++) {
                      var o = t[e + 0];
                      'variable' === o.type && (addAlias(o, 'variable-input'), i.push(o.content));
                    }
                    e = r + 1;
                  }
                  if (
                    ...
                    for (var p = e; p < s; p++) {
                      var l = t[p];
                      'variable' === l.type && i.indexOf(l.content) >= 0 && addAlias(l, 'variable-input');
                    }
                  }
                }
              }
      ...
      (n.exports = graphql), (graphql.displayName = 'graphql'), (graphql.aliases = []);
    }
  }
]);
