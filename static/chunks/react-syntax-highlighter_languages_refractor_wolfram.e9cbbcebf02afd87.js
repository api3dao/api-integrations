    ...
    28257: function (a) {
      function wolfram(a) {
        (a.languages.wolfram = {
          ...
          (a.languages.mathematica = a.languages.wolfram),
          (a.languages.wl = a.languages.wolfram),
          (a.languages.nb = a.languages.wolfram);
      }
      (a.exports = wolfram), (wolfram.displayName = 'wolfram'), (wolfram.aliases = ['mathematica', 'wl', 'nb']);
    }
  }
]);
