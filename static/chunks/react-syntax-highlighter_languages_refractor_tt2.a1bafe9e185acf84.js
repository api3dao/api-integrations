              ...
              value: function (t, n, a, r) {
                if (t.language === n) {
                  ...
                  (t.code = t.code.replace(a, function (e) {
                    ...
                    for (var a, i = o.length; -1 !== t.code.indexOf((a = getPlaceholder(n, i))); ) ++i;
                    return (o[i] = e), a;
                  })),
            ...
            tokenizePlaceholders: {
              value: function (t, n) {
                ...
                function walkTokens(o) {
                  for (var i = 0; i < o.length && !(a >= r.length); i++) {
                    var s = o[i];
                    if ('string' == typeof s || (s.content && 'string' == typeof s.content)) {
                      var l = r[a],
                        g = t.tokenStack[l],
                        u = 'string' == typeof s ? s : s.content,
                        p = getPlaceholder(n, l),
                        c = u.indexOf(p);
                      if (c > -1) {
                        ++a;
                        var k = u.substring(0, c),
                          d = new e.Token(n, e.tokenize(g, t.grammar), 'language-' + n, g),
                          f = u.substring(c + p.length),
                          m = [];
                        k && m.push.apply(m, walkTokens([k])),
                          m.push(d),
                          f && m.push.apply(m, walkTokens([f])),
                          'string' == typeof s ? o.splice.apply(o, [i, 1].concat(m)) : (s.content = m);
                      }
