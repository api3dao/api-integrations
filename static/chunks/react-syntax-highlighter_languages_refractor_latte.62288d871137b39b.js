              ...
              value: function (a, t, n, i) {
                if (a.language === t) {
                  ...
                  (a.code = a.code.replace(n, function (e) {
                    ...
                    for (var n, l = s.length; -1 !== a.code.indexOf((n = getPlaceholder(t, l))); ) ++l;
                    return (s[l] = e), n;
                  })),
            ...
            tokenizePlaceholders: {
              value: function (a, t) {
                ...
                function walkTokens(s) {
                  for (var l = 0; l < s.length && !(n >= i.length); l++) {
                    var r = s[l];
                    if ('string' == typeof r || (r.content && 'string' == typeof r.content)) {
                      var o = i[n],
                        p = a.tokenStack[o],
                        d = 'string' == typeof r ? r : r.content,
                        c = getPlaceholder(t, o),
                        u = d.indexOf(c);
                      if (u > -1) {
                        ++n;
                        ...
                        b && m.push.apply(m, walkTokens([b])),
                          ...
                          'string' == typeof r ? s.splice.apply(s, [l, 1].concat(m)) : (r.content = m);
                      }
                    } else r.content && walkTokens(r.content);
                  }
                  return s;
                }
              }
