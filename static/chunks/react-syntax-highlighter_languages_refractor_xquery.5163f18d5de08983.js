...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [982],
  {
    82420: function (e) {
            ...
            walkTokens = function (t) {
              for (var n = [], a = 0; a < t.length; a++) {
                ...
                if (
                  ('string' != typeof o &&
                    ('tag' === o.type && o.content[0] && 'tag' === o.content[0].type
                      ? '</' === o.content[0].content[0].content
                        ? n.length > 0 && n[n.length - 1].tagName === stringifyToken(o.content[0].content[1]) && n.pop()
                        : '/>' === o.content[o.content.length - 1].content ||
                          n.push({ tagName: stringifyToken(o.content[0].content[1]), openedBraces: 0 })
                      : !(n.length > 0) ||
                        'punctuation' !== o.type ||
                        '{' !== o.content ||
                        (t[a + 1] && 'punctuation' === t[a + 1].type && '{' === t[a + 1].content) ||
                        (t[a - 1] && 'plain-text' === t[a - 1].type && '{' === t[a - 1].content)
                      ? n.length > 0 &&
                  ...
                  var r = stringifyToken(o);
                  a < t.length - 1 &&
                    ('string' == typeof t[a + 1] || 'plain-text' === t[a + 1].type) &&
                    ((r += stringifyToken(t[a + 1])), t.splice(a + 1, 1)),
                    a > 0 &&
                      ('string' == typeof t[a - 1] || 'plain-text' === t[a - 1].type) &&
                      ((r = stringifyToken(t[a - 1]) + r), t.splice(a - 1, 1), a--),
                    /^\s+$/.test(r) ? (t[a] = r) : (t[a] = new e.Token('plain-text', r, null, r));
                }
                o.content && 'string' != typeof o.content && walkTokens(o.content);
              }
            };
      ...
      (e.exports = xquery), (xquery.displayName = 'xquery'), (xquery.aliases = []);
    }
  }
]);
