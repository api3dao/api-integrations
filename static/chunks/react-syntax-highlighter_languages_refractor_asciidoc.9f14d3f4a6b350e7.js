    ...
    95410: function (t) {
      function asciidoc(t) {
        !(function (t) {
          ...
          function copyFromAsciiDoc(t) {
            t = t.split(' ');
            for (var n = {}, e = 0, a = t.length; e < a; e++) n[t[e]] = i[t[e]];
            return n;
          }
          (n.inside.interpreted.inside.rest = copyFromAsciiDoc('macro inline replacement entity')),
            (i['passthrough-block'].inside.rest = copyFromAsciiDoc('macro')),
            (i['literal-block'].inside.rest = copyFromAsciiDoc('callout')),
            (i.table.inside.rest = copyFromAsciiDoc(
              'comment-block passthrough-block literal-block other-block list-punctuation indented-block comment title attribute-entry attributes hr page-break admonition list-label callout macro inline replacement entity line-continuation'
            )),
            (i['other-block'].inside.rest = copyFromAsciiDoc(
              'table list-punctuation indented-block comment attribute-entry attributes hr page-break admonition list-label macro inline replacement entity line-continuation'
            )),
            (i.title.inside.rest = copyFromAsciiDoc('macro inline replacement entity')),
      ...
      (t.exports = asciidoc), (asciidoc.displayName = 'asciidoc'), (asciidoc.aliases = ['adoc']);
    }
  }
]);
