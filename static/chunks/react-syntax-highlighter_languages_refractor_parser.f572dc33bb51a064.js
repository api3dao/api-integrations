    ...
    40085: function (e) {
      function parser(e) {
        ...
        (a = e.languages.parser =
          ...
          (a = e.languages.insertBefore('parser', 'keyword', {
          ...
          e.languages.insertBefore(
            ...
            'punctuation',
            {
              ...
              function: a.function,
              escape: a.escape,
              'parser-punctuation': { pattern: a.punctuation, alias: 'punctuation' }
            },
            a.tag.inside['attr-value']
          );
      }
      (e.exports = parser), (parser.displayName = 'parser'), (parser.aliases = []);
    }
  }
]);
