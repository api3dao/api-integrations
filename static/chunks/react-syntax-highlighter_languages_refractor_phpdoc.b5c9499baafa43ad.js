...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4884, 902, 3047, 2227],
  {
    36859: function (e) {
      function javadoclike(e) {
        !(function (e) {
          ...
          function docCommentSupport(a, t) {
            var n = 'doc-comment',
              i = e.languages[a];
            if (i) {
              var s = i[n];
              if (!s) {
                var r = {};
                (r[n] = { pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/, lookbehind: !0, alias: 'comment' }),
                  (s = (i = e.languages.insertBefore(a, 'comment', r))[n]);
              }
              if ((s instanceof RegExp && (s = i[n] = { pattern: s }), Array.isArray(s)))
                for (var o = 0, l = s.length; o < l; o++) s[o] instanceof RegExp && (s[o] = { pattern: s[o] }), t(s[o]);
              else t(s);
            }
          }
            ...
            value: function (e, a) {
              'string' == typeof e && (e = [e]),
                e.forEach(function (e) {
                  docCommentSupport(e, function (e) {
      ...
      (e.exports = javadoclike), (javadoclike.displayName = 'javadoclike'), (javadoclike.aliases = []);
    },
    92223: function (e) {
      function markupTemplating(e) {
        !(function (e) {
          function getPlaceholder(e, a) {
            return '___' + e.toUpperCase() + a + '___';
          }
          Object.defineProperties((e.languages['markup-templating'] = {}), {
            buildPlaceholders: {
              value: function (a, t, n, i) {
                if (a.language === t) {
                  var s = (a.tokenStack = []);
                  (a.code = a.code.replace(n, function (e) {
                    if ('function' == typeof i && !i(e)) return e;
                    for (var n, r = s.length; -1 !== a.code.indexOf((n = getPlaceholder(t, r))); ) ++r;
                    return (s[r] = e), n;
                  })),
            ...
            tokenizePlaceholders: {
              value: function (a, t) {
                ...
                function walkTokens(s) {
                  for (var r = 0; r < s.length && !(n >= i.length); r++) {
                    var o = s[r];
                    if ('string' == typeof o || (o.content && 'string' == typeof o.content)) {
                      var l = i[n],
                        p = a.tokenStack[l],
                        d = 'string' == typeof o ? o : o.content,
                        c = getPlaceholder(t, l),
                        u = d.indexOf(c);
                      if (u > -1) {
                        ++n;
                        var b = d.substring(0, u),
                          g = new e.Token(t, e.tokenize(p, a.grammar), 'language-' + t, p),
                          f = d.substring(u + c.length),
                          m = [];
                        b && m.push.apply(m, walkTokens([b])),
                          m.push(g),
                          f && m.push.apply(m, walkTokens([f])),
                          'string' == typeof o ? s.splice.apply(s, [r, 1].concat(m)) : (o.content = m);
                      }
    ...
    34455: function (e, a, t) {
      ...
      (e.exports = phpdoc), (phpdoc.displayName = 'phpdoc'), (phpdoc.aliases = []);
    }
  }
]);
