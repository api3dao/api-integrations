    ...
    25550: function (n) {
      function gn(n) {
        (n.languages.gn = {
          ...
          (n.languages.gn['string-literal'].inside.interpolation.inside.expression.inside = n.languages.gn),
          (n.languages.gni = n.languages.gn);
      }
      (n.exports = gn), (gn.displayName = 'gn'), (gn.aliases = ['gni']);
    }
  }
]);
