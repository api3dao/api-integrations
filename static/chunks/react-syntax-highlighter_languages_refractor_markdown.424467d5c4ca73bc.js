...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9835],
  {
    33141: function (n) {
        ...
        !(function (n) {
          ...
          (n.languages.markdown = n.languages.extend('markup', {})),
            ...
            n.hooks.add('after-tokenize', function (n) {
              ('markdown' === n.language || 'md' === n.language) && walkTokens(n.tokens);
              function walkTokens(n) {
                if (n && 'string' != typeof n)
                  for (var e = 0, t = n.length; e < t; e++) {
                    ...
                    if (
                      ...
                      var o = r.content.replace(/\b#/g, 'sharp').replace(/\b\+\+/g, 'pp'),
            ...
            n.hooks.add('wrap', function (e) {
              if ('code-block' === e.type) {
                ...
                var l = n.languages[t];
                if (l) e.content = n.highlight(textContent(e.content.value), l, t);
          ...
          function textContent(n) {
            return n.replace(i, '').replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (n, e) {
              return '#' === (e = e.toLowerCase())[0]
                ? l('x' === e[1] ? parseInt(e.slice(2), 16) : Number(e.slice(1)))
                : o[e] || n;
            });
          }
      ...
      (n.exports = markdown), (markdown.displayName = 'markdown'), (markdown.aliases = ['md']);
    }
  }
]);
