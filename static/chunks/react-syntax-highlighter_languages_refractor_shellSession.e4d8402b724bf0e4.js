...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7976, 8765],
  {
    4376: function (e) {
      function bash(e) {
        !(function (e) {
          var s =
            ...
            t = {
              bash: n,
              environment: { pattern: RegExp('\\$' + s), alias: 'constant' },
              variable: [
                {
                  pattern: /\$?\(\([\s\S]+?\)\)/,
                  greedy: !0,
                ...
                { pattern: /\$\((?:\([^)]+\)|[^()])+\)|`[^`]+`/, greedy: !0, inside: { variable: /^\$\(|^`|\)$|`$/ } },
                {
                  ...
                  inside: {
                    operator: /:[-=?+]?|[!\/]|##?|%%?|\^\^?|,,?/,
                    punctuation: /[\[\]]/,
                    environment: { pattern: RegExp('(\\{)' + s), lookbehind: !0, alias: 'constant' }
                  }
                },
                /\$(?:\w+|[#?*!@$])/
              ],
          ...
          (e.languages.bash = {
            ...
            'assign-left': {
              pattern: /(^|[\s;|&]|[<>]\()\w+(?=\+?=)/,
              inside: {
                environment: { pattern: RegExp('(^|[\\s;|&]|[<>]\\()' + s), lookbehind: !0, alias: 'constant' }
              },
              alias: 'variable',
              lookbehind: !0
            },
            string: [
              { pattern: /((?:^|[^<])<<-?\s*)(\w+)\s[\s\S]*?(?:\r?\n|\r)\2/, lookbehind: !0, greedy: !0, inside: t },
              {
      ...
      (e.exports = bash), (bash.displayName = 'bash'), (bash.aliases = ['shell']);
    },
    62429: function (e, s, n) {
      var t = n(4376);
      ...
      (e.exports = shellSession), (shellSession.displayName = 'shellSession'), (shellSession.aliases = []);
    }
  }
]);
