          ...
          (function (E) {
            ...
            E.languages.apex = {
              ...
              'class-name': [
                ...
                { pattern: insertClassName(/(\(\s*)<CLASS-NAME>(?=\s*\)\s*[\w(])/.source), lookbehind: !0, inside: I },
                { pattern: insertClassName(/<CLASS-NAME>(?=\s*\w+\s*[;=,(){:])/.source), inside: I }
              ],
