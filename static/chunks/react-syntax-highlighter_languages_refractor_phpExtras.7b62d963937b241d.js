...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [5793, 3047, 2227],
  {
                ...
                function walkTokens(s) {
                  for (var r = 0; r < s.length && !(n >= i.length); r++) {
                    ...
                    if ('string' == typeof l || (l.content && 'string' == typeof l.content)) {
                      ...
                      if (b > -1) {
                        ++n;
                        var u = d.substring(0, b),
                          g = new e.Token(t, e.tokenize(p, a.grammar), 'language-' + t, p),
                          f = d.substring(b + c.length),
                          h = [];
                        u && h.push.apply(h, walkTokens([u])),
                          h.push(g),
                          f && h.push.apply(h, walkTokens([f])),
                          'string' == typeof l ? s.splice.apply(s, [r, 1].concat(h)) : (l.content = h);
                      }
    ...
    17749: function (e, a, t) {
      ...
      (e.exports = phpExtras), (phpExtras.displayName = 'phpExtras'), (phpExtras.aliases = []);
    },
