...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8692],
  {
    81916: function (e) {
      function webIdl(e) {
        !(function (e) {
          ...
          for (var i in ((e.languages['web-idl'] = {
            ...
            'class-name': [
              { pattern: /(^|[^\w-])(?:iterable|maplike|setlike)\s*<(?:[^<>]|<[^<>]*>)*>/, lookbehind: !0, inside: t },
              {
              ...
              {
                pattern: RegExp('(' + /\bcallback\s+/.source + n + /\s*=\s*/.source + ')' + r),
                lookbehind: !0,
                inside: t
              },
              ...
              { pattern: RegExp(r + '(?=' + /\s*(?:\.{3}\s*)?/.source + n + /\s*[(),;=]/.source + ')'), inside: t }
            ],
            builtin:
      ...
      (e.exports = webIdl), (webIdl.displayName = 'webIdl'), (webIdl.aliases = []);
    }
  }
]);
