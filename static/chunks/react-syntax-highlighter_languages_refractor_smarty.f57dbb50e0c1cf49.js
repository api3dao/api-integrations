...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [849, 3047],
  {
      ...
      function markupTemplating(e) {
        !(function (e) {
          ...
          Object.defineProperties((e.languages['markup-templating'] = {}), {
            buildPlaceholders: {
              value: function (n, t, a, r) {
                if (n.language === t) {
                  var s = (n.tokenStack = []);
                  (n.code = n.code.replace(a, function (e) {
                    if ('function' == typeof r && !r(e)) return e;
                    for (var a, i = s.length; -1 !== n.code.indexOf((a = getPlaceholder(t, i))); ) ++i;
                    return (s[i] = e), a;
                  })),
            ...
            tokenizePlaceholders: {
              value: function (n, t) {
                ...
                function walkTokens(s) {
                  for (var i = 0; i < s.length && !(a >= r.length); i++) {
                    var o = s[i];
                    if ('string' == typeof o || (o.content && 'string' == typeof o.content)) {
                      var p = r[a],
                        l = n.tokenStack[p],
                        u = 'string' == typeof o ? o : o.content,
                        g = getPlaceholder(t, p),
                        d = u.indexOf(g);
                      if (d > -1) {
                        ++a;
                        var c = u.substring(0, d),
                          m = new e.Token(t, e.tokenize(l, n.grammar), 'language-' + t, l),
                          k = u.substring(d + g.length),
                          f = [];
                        c && f.push.apply(f, walkTokens([c])),
                          f.push(m),
                          k && f.push.apply(f, walkTokens([k])),
                          'string' == typeof o ? s.splice.apply(s, [i, 1].concat(f)) : (o.content = f);
                      }
    ...
    61916: function (e, n, t) {
      ...
      (e.exports = smarty), (smarty.displayName = 'smarty'), (smarty.aliases = []);
    }
  }
]);
