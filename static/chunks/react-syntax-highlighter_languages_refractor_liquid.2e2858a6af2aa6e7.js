...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1323, 3047],
  {
    62365: function (e, t, n) {
      ...
      (e.exports = liquid), (liquid.displayName = 'liquid'), (liquid.aliases = []);
    },
    92223: function (e) {
              ...
              value: function (t, n, a, i) {
                if (t.language === n) {
                  ...
                  (t.code = t.code.replace(a, function (e) {
                    ...
                    for (var a, r = o.length; -1 !== t.code.indexOf((a = getPlaceholder(n, r))); ) ++r;
                    return (o[r] = e), a;
                  })),
            ...
            tokenizePlaceholders: {
              value: function (t, n) {
                ...
                function walkTokens(o) {
                  for (var r = 0; r < o.length && !(a >= i.length); r++) {
                    var l = o[r];
                    if ('string' == typeof l || (l.content && 'string' == typeof l.content)) {
                      var s = i[a],
                        c = t.tokenStack[s],
                        u = 'string' == typeof l ? l : l.content,
                        p = getPlaceholder(n, s),
                        d = u.indexOf(p);
                      if (d > -1) {
                        ++a;
                        var g = u.substring(0, d),
                          m = new e.Token(n, e.tokenize(c, t.grammar), 'language-' + n, c),
                          f = u.substring(d + p.length),
                          k = [];
                        g && k.push.apply(k, walkTokens([g])),
                          k.push(m),
                          f && k.push.apply(k, walkTokens([f])),
                          'string' == typeof l ? o.splice.apply(o, [r, 1].concat(k)) : (l.content = k);
                      }
