      ...
      function java(e) {
        ...
        (a =
          ...
          (e.languages.java = e.languages.extend('clike', {
            ...
            'class-name': [
              n,
              { pattern: RegExp(t + /[A-Z]\w*(?=\s+\w+\s*[;,=()])/.source), lookbehind: !0, inside: n.inside }
            ],
            keyword: a,
          ...
          e.languages.insertBefore('java', 'class-name', {
            ...
            generics: {
              pattern:
                /<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&)|<(?:[\w\s,.?]|&(?!&))*>)*>)*>)*>/,
              inside: { 'class-name': n, keyword: a, punctuation: /[<>(),.:]/, operator: /[?&|]/ }
            },
            namespace: {
              pattern: RegExp(
            ...
            'string-interpolation': {
              ...
              inside: {
                ...
                interpolation: {
                  pattern: /\$(?:\w+|\{(?:[^{}]|\{[^{}]*\})*\})/,
                  greedy: !0,
                  inside: { punctuation: /^\$\{?|\}$/, expression: { pattern: /[\s\S]+/, inside: e.languages.scala } }
                },
                string: /[\s\S]+/
              }
            }
