            ...
            <>
              {comparePair.left === null && comparePair.right === null ? null : (
                <Stack direction={'row'} justifyContent={'center'}>
                  <CompareId
                    deleteActive={comparePair.left != null}
                    header={'New'}
                    onClick={() => {
                    ...
                    text={
                      comparePair.left == null
                        ? 'Click on a provider to compare it with another'
                        : comparePair.left.stage
                    }
                  />
                  <Flex alignItems={'center'} justifyItems={'center'}>
                    <Text align={'center'} fontSize={'sm'} fontWeight={'bold'} color={'gray.500'}>
                      VS
                    </Text>
                  </Flex>
                  <CompareId
                    deleteActive={comparePair.right != null}
                    header={'Old'}
                    onClick={() => {
