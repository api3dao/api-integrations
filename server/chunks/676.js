...
(exports.id = 676),
  ...
  (exports.modules = {
    28676: (e, t, n) => {
      ...
      let r = _interop_require_default(n(16689)),
        i = n(74191),
        o = n(75778),
        s = n(79630),
        l = _interop_require_default(n(80676)),
        a = n(3112);
      ...
      function getPolyfillScripts(e, t) {
        let { assetPrefix: n, buildManifest: i, assetQueryString: o, disableOptimizedLoading: s, crossOrigin: l } = e;
      ...
      function AmpStyles({ styles: e }) {
        ...
        if (e.props && Array.isArray(e.props.children)) {
          ...
          e.props.children.forEach((e) => {
            Array.isArray(e) ? e.forEach((e) => hasStyles(e) && t.push(e)) : hasStyles(e) && t.push(e);
          });
        }
      ...
      function getScripts(e, t, n) {
        ...
        let {
          ...
          p = null == (i = s.lowPriorityFiles) ? void 0 : i.filter((e) => e.endsWith('.js'));
        return [...d, ...p].map((e) =>
          r.default.createElement('script', {
            key: e,
      ...
      function getPreNextWorkerScripts(e, t) {
        ...
        try {
          ...
          `
            ...
            (i.worker || []).map((e, n) => {
              let { strategy: i, src: s, children: l, dangerouslySetInnerHTML: a, ...u } = e,
                c = {};
              if (s) c.src = s;
              else if (a && a.__html) c.dangerouslySetInnerHTML = { __html: a.__html };
              else if (l)
                c.dangerouslySetInnerHTML = { __html: 'string' == typeof l ? l : Array.isArray(l) ? l.join('') : '' };
              else
                throw Error(
      ...
      let Head = class Head extends r.default.Component {
        ...
        getCssLinks(e) {
          ...
          if (d.length) {
            let e = new Set(a);
            (d = d.filter((t) => !(e.has(t) || u.has(t)))), (c = new Set(d)), a.push(...d);
          }
          let p = [];
          return (
            a.forEach((e) => {
        ...
        getBeforeInteractiveInlineScripts() {
          ...
          return (e.beforeInteractive || [])
            ...
            .map((e, i) => {
              let { strategy: o, children: s, dangerouslySetInnerHTML: l, src: a, ...u } = e,
                c = '';
              return (
                l && l.__html
                  ? (c = l.__html)
        ...
        render() {
            ...
            (S.forEach((e) => {
              ...
              this.context.strictNextHead && (t = r.default.createElement('meta', { name: 'next-head', content: '1' })),
                e && 'link' === e.type && 'preload' === e.props.rel && 'style' === e.props.as
                  ? (t && y.push(t), y.push(e))
                  : e && (t && ('meta' !== e.type || !e.props.charSet) && I.push(t), I.push(e));
            }),
            (S = y.concat(I)));
          let P = r.default.Children.toArray(this.props.children).filter(Boolean);
          ...
          let O = getDocumentFiles(this.context.buildManifest, this.context.__NEXT_DATA__.page, i),
          ...
          return r.default.createElement(
            ...
            P,
            m && r.default.createElement('meta', { name: 'next-font-preconnect' }),
            b.preconnect,
            b.preload,
            i &&
              r.default.createElement(
                ...
                !N && r.default.createElement('link', { rel: 'canonical', href: s + n(50733).cleanAmpPath(a) }),
                r.default.createElement('link', {
                  rel: 'preload',
                  as: 'script',
            ...
            !i &&
              r.default.createElement(
                r.default.Fragment,
                null,
                !T && o && r.default.createElement('link', { rel: 'amphtml', href: s + getAmpPath(t, a) }),
                this.getBeforeInteractiveInlineScripts(),
                !f && this.getCssLinks(O),
                !f && r.default.createElement('noscript', { 'data-n-css': this.props.nonce ?? '' }),
      ...
      function handleDocumentScriptLoaderItems(e, t, n) {
        ...
        let a = [],
          ...
          c = null == (o = u.find((e) => e.type === Head)) ? void 0 : null == (i = o.props) ? void 0 : i.children,
          d = null == (l = u.find((e) => 'body' === e.type)) ? void 0 : null == (s = l.props) ? void 0 : s.children,
          ...
          try {
            ...
            return (
              r &&
                ...
                } is ${l(o)} which exceeds the threshold of ${l(r)}, this amount of data can reduce performance.
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
        ...
        render() {
          ...
          let c = getDocumentFiles(this.context.buildManifest, this.context.__NEXT_DATA__.page, t);
          return r.default.createElement(
            r.default.Fragment,
            null,
            !u && n.devFiles
            ...
            u
              ...
              : r.default.createElement('script', {
                  ...
                  nonce: this.props.nonce,
                  crossOrigin: this.props.crossOrigin || a,
                  dangerouslySetInnerHTML: { __html: NextScript.getInlineScriptSource(this.context) }
                }),
    ...
    74191: (e, t, n) => {
      ...
      let r = n(50167),
        ...
        s = ['x-invoke-path', 'x-invoke-status', 'x-invoke-error', 'x-invoke-query', 'x-middleware-invoke'],
          ...
          if (r.startsWith('[') && r.endsWith(']')) {
            ...
            if (n) {
              if (o) {
                ...
                handleSlug(this.optionalRestSlugName, i), (this.optionalRestSlugName = i), (r = '[[...]]');
              } else {
                if (null != this.optionalRestSlugName)
                  throw Error(
                ...
                handleSlug(this.restSlugName, i), (this.restSlugName = i), (r = '[...]');
              }
            } else {
    ...
    50733: (e, t, n) => {
      ...
      function debounce(e, t, n = 1 / 0) {
        ...
        function run() {
          let a = Date.now(),
            u = l + t - a;
          u <= 0 || s + n >= a ? ((r = void 0), e.apply(o, i)) : (r = setTimeout(run, u));
        }
        return function (...e) {
          (i = e), (o = this), (l = Date.now()), void 0 === r && ((s = l), (r = setTimeout(run, t)));
        };
      }
    }
  });
