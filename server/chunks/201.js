...
(exports.id = 201),
      ...
      ((e, r) => {
        ...
        (e.exports = ((e, n, a, s) => {
          if ((n && 'object' == typeof n) || 'function' == typeof n)
            for (let a of i(n))
              o.call(e, a) || void 0 === a || t(e, a, { get: () => n[a], enumerable: !(s = r(n, a)) || s.enumerable });
          return e;
      ...
      function splitCookiesString(e) {
        ...
        for (; s < e.length; ) {
          for (t = s, n = !1; skipWhitespace(); )
            if (',' === (r = e.charAt(s))) {
              for (i = s, s += 1, skipWhitespace(), o = s; s < e.length && notSpecialChar(); ) s += 1;
      ...
      var l = class {
        ...
        u = class {
          constructor(e) {
            ...
            (this._parsed = new Map()), (this._headers = e);
            let o =
                null != (i = null != (r = null == (t = e.getSetCookie) ? void 0 : t.call(e)) ? r : e.get('set-cookie'))
                  ? i
                  : [],
          ...
          set(...e) {
            let [t, r, i] = 1 === e.length ? [e[0].name, e[0].value, e[0]] : e,
              o = this._parsed;
            return o.set(t, normalizeCookie({ name: t, value: r, ...i })), replace(o, this._headers), this;
          }
          delete(...e) {
            let [t, r, i] = 'string' == typeof e[0] ? [e[0]] : [e[0].name, e[0].path, e[0].domain];
            return this.set({ name: t, path: r, domain: i, value: '', expires: new Date(0) });
          }
          [Symbol.for('edge-runtime.inspect.custom')]() {
            ...
            226: function (o, n) {
              !(function (a, s) {
                var l = 'function',
                  ...
                  trim = function (e, t) {
                    if (typeof e === c) return (e = e.replace(/^\s\s*/, '')), typeof t === u ? e : e.substring(0, 350);
                  },
                              ...
                              typeof (n = p[o]) === d && n.length > 0
                                ? 2 === n.length
                                  ? typeof n[1] == l
                                    ...
                                    : (this[n[0]] = n[1])
                                  : 3 === n.length
                                  ? typeof n[1] !== l || (n[1].exec && n[1].test)
                                    ? (this[n[0]] = u ? u.replace(n[1], n[2]) : s)
                                    : (this[n[0]] = u ? n[1].call(this, u, n[2]) : s)
                                  : 4 === n.length && (this[n[0]] = u ? n[3].call(this, u.replace(n[1], n[2])) : s)
                                : (this[n] = u || s);
                      c += 2;
                    }
                  },
                  strMapper = function (e, t) {
                    for (var r in t)
                      if (typeof t[r] === d && t[r].length > 0) {
                        for (var i = 0; i < t[r].length; i++) if (has(t[r][i], e)) return '?' === r ? s : r;
                  ...
                  UAParser = function (e, t) {
                    if ((typeof e === d && ((t = e), (e = s)), !(this instanceof UAParser)))
                    ...
                    return (
                      (this.getBrowser = function () {
                        ...
                        return (
                          ...
                          (t[h] = typeof (e = t[g]) === c ? e.replace(/[^\d\.]/g, '').split('.')[0] : s),
                          v && r && r.brave && typeof r.brave.isBrave == l && (t[b] = 'Brave'),
                          t
                        );
                      }),
                      ...
                      (this.getEngine = function () {
                        var e = {};
                        return (e[b] = s), (e[g] = s), rgxMapper.call(e, i, n.engine), e;
                      }),
                      (this.getOS = function () {
                        var e = {};
                        return (
                          ...
                          v &&
                            ...
                            o &&
                            'Unknown' != o.platform &&
                            (e[b] = o.platform.replace(/chrome os/i, B).replace(/macos/i, W)),
                          e
                        );
                      }),
                      ...
                      (this.setUA = function (e) {
                        return (i = typeof e === c && e.length > 350 ? trim(e, 350) : e), this;
                      }),
                      this.setUA(i),
                      this
                    );
                ...
                (UAParser.VERSION = '1.0.35'),
                  ...
                  typeof n !== u
                    ? (o.exports && (n = o.exports = UAParser), (n.UAParser = UAParser))
                    : r.amdO
                    ? void 0 !==
                        (i = function () {
                          return UAParser;
  ...
  `);
      ...
      let NextURL = class NextURL {
        constructor(e, t, r) {
          ...
          ('object' == typeof t && 'pathname' in t) || 'string' == typeof t
            ? ((i = t), (o = r || {}))
            : (o = r || t || {}),
            (this[l] = { url: parseURL(e, i ?? o.base), options: o, basePath: '' }),
            this.analyze();
        }
        analyze() {
          var e, t, r, o, s;
          ...
          this[l].domainLocale = this[l].options.i18nProvider
            ...
            : (0, i.detectDomainLocale)(
                null == (t = this[l].options.nextConfig) ? void 0 : null == (e = t.i18n) ? void 0 : e.domains,
                d
              );
          let c =
            (null == (r = this[l].domainLocale) ? void 0 : r.defaultLocale) ||
            (null == (s = this[l].options.nextConfig) ? void 0 : null == (o = s.i18n) ? void 0 : o.defaultLocale);
        ...
        set locale(e) {
          ...
          if (
            !this[l].locale ||
            !(null == (r = this[l].options.nextConfig) ? void 0 : null == (t = r.i18n) ? void 0 : t.locales.includes(e))
          )
    ...
    67715: (e, t, r) => {
      ...
      function handleMiddlewareField(e, t) {
        ...
        if (null == e ? void 0 : null == (r = e.request) ? void 0 : r.headers) {
          ...
          let r = [];
          for (let [i, o] of e.request.headers) t.set('x-middleware-request-' + i, o), r.push(i);
      ...
      let NextResponse = class NextResponse extends Response {
        ...
        static redirect(e, t) {
          ...
          if (!s.has(r)) throw RangeError('Failed to execute "redirect" on "response": Invalid status code');
          let i = 'object' == typeof t ? t : {},
            n = new Headers(null == i ? void 0 : i.headers);
          return n.set('Location', (0, o.validateURL)(e)), new NextResponse(null, { ...i, headers: n, status: r });
        }
        static rewrite(e, t) {
        ...
        static next(e) {
          ...
          return (
            t.set('x-middleware-next', '1'), handleMiddlewareField(e, t), new NextResponse(null, { ...e, headers: t })
          );
        }
      };
    },
    91654: (e, t, r) => {
      ...
      let i = _interop_require_default(r(85842));
    ...
    21542: (e, t) => {
      function fromNodeOutgoingHttpHeaders(e) {
        ...
        for (let [r, i] of Object.entries(e)) {
          ...
          for (let i of e) void 0 !== i && ('number' == typeof i && (i = i.toString()), t.append(r, i));
        }
        return t;
      }
      function splitCookiesString(e) {
        ...
        if (e)
          for (let [i, o] of e.entries())
            'set-cookie' === i.toLowerCase()
              ? (r.push(...splitCookiesString(o)), (t[i] = 1 === r.length ? r[0] : r))
              : (t[i] = o);
        return t;
      }
      ...
      function detectDomainLocale(e, t, r) {
        if (e)
          for (let n of (r && (r = r.toLowerCase()), e)) {
            var i, o;
            let e = null == (i = n.domain) ? void 0 : i.split(':', 1)[0].toLowerCase();
            if (
              t === e ||
              r === n.defaultLocale.toLowerCase() ||
              (null == (o = n.locales) ? void 0 : o.some((e) => e.toLowerCase() === r))
            )
              return n;
          }
      }
    ...
    90446: (e, t, r) => {
      ...
      function addLocale(e, t, r, n) {
        if (!t || t === r) return e;
        let a = e.toLowerCase();
        return !n && ((0, o.pathHasPrefix)(a, '/api') || (0, o.pathHasPrefix)(a, '/' + t.toLowerCase()))
          ? e
    ...
    2020: (e, t, r) => {
      ...
      function getNextPathnameInfo(e, t) {
        ...
        s &&
          ...
          ((d.pathname = (0, o.removePathPrefix)(d.pathname, s)), (d.basePath = s));
        let c = d.pathname;
        ...
        if (l) {
          ...
          (d.locale = e.detectedLocale),
            ...
            !e.detectedLocale &&
              d.buildId &&
              (e = t.i18nProvider ? t.i18nProvider.analyze(c) : (0, i.normalizeLocalePath)(c, l.locales))
                .detectedLocale &&
              (d.locale = e.detectedLocale);
        }
        return d;
    ...
    31057: (e, t, r) => {
      let i = {
        ...
        NextResponse: r(67715).x,
        ImageResponse: r(92020).E,
        userAgentFromString: r(91654).userAgentFromString,
        userAgent: r(91654).userAgent
      };
